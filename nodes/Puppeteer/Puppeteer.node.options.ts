import { type INodeTypeDescription, type INodeProperties } from "n8n-workflow";
...
export function isRunningInContainer(): boolean {
  try {
    ...
    if (
      ...
      console.log(
        "Puppeteer node: Container detected via environment variables",
      );
      return true;
    }
    ...
    console.log(
      "Puppeteer node: Container detection failed:",
 ...
 */
const buildProperties = (): INodeProperties[] => {
  const properties: any[] = [
    ...
    },
    {
      ...
      default: "",
      description:
        "HTML template for the print footer. Should be valid HTML with the following classes used to inject values into them: - date formatted print date",
      noDataExpression: true,
      displayOptions: {
        show: {
          operation: ["getPDF"],
      ...
      : []),
    {
      ...
      options: [
        ...
        },
        {
          ...
          default: "cdp",
          description:
            "The protocol to use when connecting to the browser. Use WebDriver BiDi for Firefox support. Can also be set globally via environment variable: PUPPETEER_PROTOCOL.",
          required: false,
        },
        {
        ...
        },
        {
          ...
          default: "load",
          description:
            "When to consider navigation succeeded. Has no effect on the 'Run Custom Script' operation.",
        },
        {
  ...
  return properties as INodeProperties[];
};
